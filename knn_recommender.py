...
class Recommender: 
    def __init__(self):
        ...
        min_loudness = self.df_data['loudness'].min()
        self.df_data['loudness'] = self.df_data['loudness'] + abs(min_loudness)
        max_loudness = self.df_data['loudness'].max()
        self.df_data['loudness'] = self.df_data['loudness']/max_loudness
